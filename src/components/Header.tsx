...
export const Header: React.FC = () => {
  return (
    <header className="bg-blue-700 border-b-2 border-blue-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center">
            {/* Main Title */}
            <h1 className="text-2xl md:text-3xl font-bold mb-2 text-white leading-tight">
              Home Education and Private Tutoring Annual Report
            </h1>

            {/* Subtitle Information */}
            <div className="flex flex-wrap items-center justify-center gap-3 text-blue-100 text-sm md:text-base">
            ...
            {/* Additional Context */}
            <div className="mt-2 text-blue-100 text-xs md:text-sm max-w-3xl mx-auto">
